...
class QM9infos(AbstractDatasetInfos):
    def __init__(self, datamodule, cfg, recompute_statistics=False):
        ...
        if self.remove_h:
            ...
            self.n_nodes_org = torch.tensor([0, 0, 0, 1.5287e-05, 3.0574e-05, 3.8217e-05,
            ...
            self.n_nodes = torch.zeros_like(self.n_nodes_org)
            self.n_nodes[self.n_nodes.shape[0] - 1] = 1.0
